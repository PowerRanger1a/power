...
const PlayHeader = ({ headingText }) => {
  return (
    ...
    <div className={style.wrapper} style={{ background: 'linear-gradient(rgba(7, 0, 41, 0.65), rgba(7, 0, 41, 0)),url("https://res.cloudinary.com/shariqcloud/image/upload/v1656325697/Power%20Rangers/back1_hpjzoc.webp")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'auto' }}>
